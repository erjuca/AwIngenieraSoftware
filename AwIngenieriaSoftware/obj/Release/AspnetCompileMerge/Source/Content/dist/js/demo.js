...
$(function () {
    ...
    function get(name) {
        if (typeof (Storage) !== 'undefined') {
            ...
            window.alert('Utilice un navegador moderno para ver correctamente esta plantilla!')
        }
    }
    ...
    $demoSettings.append(
        ...
        + 'Dise&ntildeo Fijo'
        + '</label>'
        + '<p>Activar el dise&ntildeo fijo . No puedes usar dise&ntildeos y en caja juntos</p>'
        + '</div>'
        // Boxed layout
        + '<div class="form-group">'
        + '<label class="control-sidebar-subheading">'
        + '<input type="checkbox"data-layout="layout-boxed" class="pull-right"/> '
        + 'Dise&ntildeo en caja'
        + '</label>'
        + '<p>Activar el dise&ntildeo en caja.</p>'
        + '</div>'
        // Sidebar Toggle
        + '<div class="form-group">'
        + '<label class="control-sidebar-subheading">'
        ...
        + 'Barra lateral Expandir sobre Hover'
        + '</label>'
        ...
        + 'Alternar a la derecha barra lateral'
        + '</label>'
        + '<p>Alternar entre diapositivas sobre contenido y empujar efectos de contenido</p>'
        + '</div>'
        // Control Sidebar Skin Toggle
        + '<div class="form-group">'
        + '<label class="control-sidebar-subheading">'
        + '<input type="checkbox"data-sidebarskin="toggle"class="pull-right"/> '
        + 'Alternar piel de barra lateral derecha'
        + '</label>'
        + '<p>Alterna entre pieles oscuras y claras para la barra lateral derecha</p>'
        + '</div>'
    )
